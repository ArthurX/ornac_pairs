...
\end{tikzpicture}
\caption{Proton Repulsice Force. When charges of the opposing polarity circle along the same axis and
 in the same direction of rotation, they create magnetic fields, which push them away from eachother.
\label{Fig:Proton_Repulsice_Force}}
\end{figure}
